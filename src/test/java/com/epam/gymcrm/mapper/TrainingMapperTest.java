...
class TrainingMapperTest {
    ...
    void toTraineeTrainingResponseShouldMapTraining() {
        ...
        assertThat(response).isEqualTo(new TraineeTrainingResponse(
                "Yoga Basics",
                "Yoga",
                LocalDate.of(2026, 5, 3),
                60,
    ...
    void toTrainerTrainingResponseShouldMapTraining() {
        ...
        assertThat(response).isEqualTo(new TrainerTrainingResponse(
                "Yoga Basics",
                "Yoga",
                LocalDate.of(2026, 5, 3),
                60,
    ...
    void toCriteriaShouldMapTraineeTrainingsRequest() {
        ...
        assertThat(criteria).isEqualTo(new TraineeTrainingCriteria(
                LocalDate.of(2026, 1, 1),
                LocalDate.of(2026, 1, 31),
                "John",
                "Yoga"
    ...
    void toCriteriaShouldMapTrainerTrainingsRequest() {
        ...
        assertThat(criteria).isEqualTo(new TrainerTrainingCriteria(
                LocalDate.of(2026, 1, 1),
                LocalDate.of(2026, 1, 31),
                "Jane"
        ));
